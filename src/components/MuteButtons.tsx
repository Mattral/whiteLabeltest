...
Source
src\components\MuteButtons.tsx (13:74) @ muteAudio

  11 |   const onMicrophoneClick = async () => {
  12 |     const mediaStream = client.current.getMediaStream();
> 13 |     isAudioMuted ? await mediaStream?.unmuteAudio() : await mediaStream?.muteAudio();
     |                                                                          ^
  14 |     setIsAudioMuted(client.current.getCurrentUserInfo().muted ?? true);
  15 |   };
  16 |   return (
*/